...
class SolucioBack {
    // attrs:
    // - magatzem amb tots els Producte que ha d'emmagatzemar l'empresa
    // - magatzems per emmagatzemar diferentes solucions
    // - atributs per controlar si es la millor solucio fins ara o no
    // - matriu d'adjecencia que s'ha de construir a partir de incopatibilitats
    //  dels productes. (consultara el backtracking si una decisio es acceptable)  
}